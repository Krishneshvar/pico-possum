...
class SqliteReportsRepositoryTest {
    ...
    private void createSchema() throws SQLException {
        ...
        connection.createStatement().execute("CREATE TABLE sales (id INTEGER PRIMARY KEY AUTOINCREMENT, customer_id INTEGER, user_id INTEGER, invoice_number TEXT, invoice_id TEXT, status TEXT DEFAULT 'completed', fulfillment_status TEXT DEFAULT 'fulfilled', total_amount REAL DEFAULT 0, paid_amount REAL DEFAULT 0, tax_amount REAL DEFAULT 0, discount REAL DEFAULT 0, payment_method_id INTEGER, sale_date TEXT DEFAULT CURRENT_TIMESTAMP)");
        ...
        connection.createStatement().execute("CREATE TABLE product_stock_cache (product_id INTEGER PRIMARY KEY, current_stock INTEGER NOT NULL DEFAULT 0, last_updated DATETIME DEFAULT CURRENT_TIMESTAMP)");
    ...
    private void seedData() throws SQLException {
        ...
        // Sale 1
        connection.createStatement().execute("INSERT INTO sales (id, customer_id, user_id, invoice_number, invoice_id, status, total_amount, paid_amount, tax_amount, discount, payment_method_id, sale_date) VALUES (1, 1, 1, 'INV-001', 'INV-001', 'completed', 1000.0, 1000.0, 0.0, 10.0, 1, '2025-06-01 12:00:00')");
        ...
        connection.createStatement().execute("INSERT INTO product_flow (product_id, event_type, quantity, event_date) VALUES (1, 'adjustment', 50, '2025-06-01 12:00:00')");
        connection.createStatement().execute("INSERT INTO product_flow (product_id, event_type, quantity, event_date) VALUES (1, 'sale', -5, '2025-06-01 12:00:00')");
        ...
        connection.createStatement().execute("INSERT INTO product_stock_cache (product_id, current_stock) VALUES (1, 3)");
        connection.createStatement().execute("INSERT INTO product_stock_cache (product_id, current_stock) VALUES (2, 0)");
    }
