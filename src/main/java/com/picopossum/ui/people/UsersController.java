        ...
        statusCol.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(String status, boolean empty) {
                ...
                if (empty || status == null) {
                    ...
                    setGraphic(com.picopossum.ui.common.components.BadgeFactory.createUserStatusBadge(
        ...
        createdCol.setCellFactory(col -> new TableCell<>() {
            ...
            protected void updateItem(java.time.LocalDateTime item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    java.time.LocalDateTime localTime = com.picopossum.shared.util.TimeUtil.toLocal(item);
                    setText(localTime != null ? com.picopossum.shared.util.TimeUtil.formatStandard(localTime) : "");
                }
            }
        });
