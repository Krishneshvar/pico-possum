    ...
    protected void setupValidators() {
        if (nameField != null) {
            com.picopossum.ui.common.validation.FieldValidator.of(nameField)
                .addValidator(com.picopossum.ui.common.validation.Validators.required("Customer name"))
                .validateOnType();
        }

        if (phoneField != null) {
            phoneField.setTextFormatter(com.picopossum.ui.common.controls.InputFilters.numericFormat());
            com.picopossum.ui.common.validation.FieldValidator.of(phoneField)
                .addValidator(com.picopossum.ui.common.validation.Validators.phone())
                .validateOnType();
        }

        if (emailField != null) {
            com.picopossum.ui.common.validation.FieldValidator.of(emailField)
                .addValidator(com.picopossum.ui.common.validation.Validators.email())
                .validateOnType();
        }
    }
