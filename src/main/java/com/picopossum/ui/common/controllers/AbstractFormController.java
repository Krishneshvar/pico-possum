...
public abstract class AbstractFormController<T> implements Parameterizable {
    ...
    protected void setupEditMode() {
        ...
        try {
            ...
            com.picopossum.infrastructure.logging.LoggingConfig.getLogger().error("Failed to load entity for editing", e);
            NotificationService.error("Failed to load " + getEntityDisplayName() + ": " + com.picopossum.ui.common.ErrorHandler.toUserMessage(e));
            closeForm();
            return;
        }
    ...
    protected void setupViewMode() {
        ...
        try {
            ...
            com.picopossum.infrastructure.logging.LoggingConfig.getLogger().error("Failed to load entity for viewing", e);
            NotificationService.error("Failed to load " + getEntityDisplayName() + ": " + com.picopossum.ui.common.ErrorHandler.toUserMessage(e));
            closeForm();
            return;
        }
