package com.picopossum.ui.transactions;
...
public class TransactionsController extends AbstractCrudController<Transaction, TransactionFilter> {
    ...
    private final com.picopossum.application.sales.SalesService salesService;
    ...
    public TransactionsController(TransactionService transactionService, 
                                  com.picopossum.application.sales.SalesService salesService,
    ...
    protected void setupTable() {
        ...
        typeCol.setCellValueFactory(cellData -> {
            ...
            return new SimpleStringProperty(com.picopossum.shared.util.TextFormatter.toTitleCase(type));
        });
        ...
        statusCol.setCellFactory(col -> new TableCell<Transaction, String>() {
            ...
            protected void updateItem(String status, boolean empty) {
                ...
                if (empty || status == null) {
                    ...
                    setGraphic(com.picopossum.ui.common.components.BadgeFactory.createTransactionStatusBadge(status));
    ...
    protected void setupFilters() {
        ...
        List<com.picopossum.domain.model.PaymentMethod> pms = salesService.getPaymentMethods();
        filterBar.addMultiSelectFilter("paymentMethod", "All Payments", pms, 
            com.picopossum.domain.model.PaymentMethod::name,
            false);
        ...
        setupStandardFilterListener((filters, reload) -> {
            ...
            List<com.picopossum.domain.model.PaymentMethod> selectedPms = (List<com.picopossum.domain.model.PaymentMethod>) filters.get("paymentMethod");
            if (selectedPms == null || selectedPms.isEmpty()) {
                currentPaymentMethodIds = null;
            } else {
                currentPaymentMethodIds = selectedPms.stream()
                    .map(com.picopossum.domain.model.PaymentMethod::id)
                    .toList();
            }
